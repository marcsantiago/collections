...
func TestIntMap64_Delete(t *testing.T) {
	type args struct {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{key: collections.IntValue64(1)},
			want: IntMap64{
				2: 10,
			},
		},
...
func TestIntMap64_Get(t *testing.T) {
	type args struct {
		key collections.Data
	}
	tests := []struct {
		...
		},
		{
			...
			args:  args{key: collections.IntValue64(10)},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !cmp.Equal(got.Int64(), tt.want.Int64()) {
...
func TestIntMap64_Items(t *testing.T) {
	tests := []struct {
		name string
		i    IntMap64
	...
	}{
		{
			...
			want: []collections.Element{
				collections.Element{Key: collections.IntValue64(1), Value: collections.IntValue(1)},
				collections.Element{Key: collections.IntValue64(2), Value: collections.IntValue(10)},
				collections.Element{Key: collections.IntValue64(3), Value: collections.IntValue(1000)},
				collections.Element{Key: collections.IntValue64(4), Value: collections.IntValue(10000)},
			},
		},
	}
	for _, tt := range tests {
...
func TestIntMap64_Iterate(t *testing.T) {
	tests := []struct {
		name string
		i    IntMap64
		want []collections.Element
...
func TestIntMap64_MostCommon(t *testing.T) {
	type args struct {
		n int
	}
	tests := []struct {
...
func TestIntMap64_Set(t *testing.T) {
	type args struct {
		key   collections.Data
...
func TestIntMap64_Subtract(t *testing.T) {
	type args struct {
		key collections.Data
	}
	tests := []struct {
...
func TestIntMap64_Update(t *testing.T) {
	type args struct {
		key collections.Data
	}
	tests := []struct {
