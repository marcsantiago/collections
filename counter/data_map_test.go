...
func TestDataMap_Delete(t *testing.T) {
	type args struct {
	...
	tests := []struct {
	...
	}{
		{
			...
			i: DataMap{
				collections.StringValue("foo"): 1,
				collections.StringValue("bar"): 10,
			},
...
func TestDataMap_Items(t *testing.T) {
	tests := []struct {
		name string
		i    DataMap
	...
	}{
		{
			...
			i: DataMap{
				collections.StringValue("foo"): 1,
				collections.StringValue("bar"): 10,
				collections.StringValue("the"): 1000,
				collections.StringValue("i"):   10000,
			},
			want: []collections.Element{
...
func TestDataMap_Iterate(t *testing.T) {
	tests := []struct {
		name string
		i    DataMap
		want []collections.Element
...
func TestDataMap_MostCommon(t *testing.T) {
	type args struct {
		n int
	}
	tests := []struct {
...
func TestDataMap_Set(t *testing.T) {
	type args struct {
		key   collections.Data
...
func TestDataMap_Subtract(t *testing.T) {
	type args struct {
		key collections.Data
	}
	tests := []struct {
...
func TestDataMap_Update(t *testing.T) {
	type args struct {
		key collections.Data
	}
	tests := []struct {
